...
$pathCertificateProd = realpath(__DIR__ . "/producao-669198-GEsport.p12"); // Absolute path to the certificate in .pem or .p12 format
...
$pathCertificateHomolog = realpath(__DIR__ . "/homologacao-669198-GEsport.p12"); // Absolute path to the certificate in .pem or .p12 format
